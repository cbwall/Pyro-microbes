...
```{r Daphnia model plots, results='hide', fig.show='hide', eval = FALSE}
######### Daphnia
...
```{r calanoid model plots, results='hide', fig.show='hide', eval=FALSE}
# Calanoid
...
```
```{r cyclopoid model plots, results='hide', fig.show='hide', eval=FALSE}
# cyclopoid
...
```
```{r nauplii model plots, results='hide', fig.show='hide', eval=FALSE}
# Nauplii
...
```{r zoop plots notused, eval=FALSE}
################
# compile figs
...
library('dplyr')
zoop.comm$Days<-dplyr::recode(zoop.comm$Time.point, T0 = 'Day-0', 
                         T1 = 'Day-10',
                         T2 = 'Day-31',
                         T3 = 'Day-59',
                         T4 = 'Day-89')
