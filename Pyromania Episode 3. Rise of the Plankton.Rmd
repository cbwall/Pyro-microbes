...
abundance.density.plot<-ggplot(z3,aes(fill=spp, y=Density.mean, x=plant.mass..g)) +
...
```{r}
# combine hellinger PCAs

Hel.PCA<-plot_grid(PCplot1.hell, PCplot2.hell, PCplot3.hell, PCplot4.hell, ncol=2)
ggsave("figures/Hell.PCA.pdf", height=8, width=10)
```
